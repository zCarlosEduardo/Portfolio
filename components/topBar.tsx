  ...
  return (
    <header
      className={`
        ...
        ${scrolled ? "border-b border-stone-800 bg-black/80 backdrop-blur" : ""}
      `}
    >
      <div className="flex text-sm text-center items-center container mx-auto py-4 px-12 justify-between">
