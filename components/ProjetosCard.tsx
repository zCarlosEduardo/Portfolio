...
export function ProjetosCard({ projeto, highlight }: ProjetosCardProps) {
  return (
    ...
    >
      ...
      <div className="relative h-48 flex items-center justify-center overflow-hidden bg-slate-800/50">
        ...
        {projeto.link ? (
          <iframe
            src={projeto.link}
            title={`Preview do projeto ${projeto.titulo}`}
        ...
        <div className="flex gap-3 mt-auto">
          {projeto.link && (
            <a
              ...
              className="group/btn flex items-center gap-2 px-5 py-3 bg-gradient-to-r from-blue-600 to-blue-500 text-white rounded-xl hover:from-blue-500 hover:to-blue-400 transition-all duration-300 flex-1 justify-center font-semibold shadow-lg hover:shadow-blue-500/50 hover:scale-105"
              aria-label={`Ver projeto ${projeto.titulo} ao vivo`}
              itemProp="url"
            >
              <ExternalLink
                size={18}
          ...
          {projeto.github && (
            <a
              ...
              aria-label={`Ver código fonte do ${projeto.titulo} no GitHub`}
