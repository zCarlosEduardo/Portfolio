    ...
    >
      ...
      <div className="max-w-4xl text-gray-800 dark:text-gray-300 flex flex-col mt-4 gap-6 px-4 md:px-0 text-center md:text-left">
        ...
        >
          ...
          <strong>sistemas web</strong>, <strong>landing pages</strong> e implemento
          soluções para <strong>automatizar processos empresariais</strong>, 
          focando em <strong>performance</strong> e <strong>escalabilidade</strong>.
        </p>
        ...
        >
          ...
          <strong>experiência do usuário (UX)</strong>. Essa combinação me permite criar
          aplicações que são tecnicamente sólidas, <strong>acessíveis</strong> e 
          intuitivas de usar.
        </p>
        ...
        <p
          ...
          itemProp="alumniOf"
        >
          <strong>Graduando em Ciências da Computação</strong> e sempre aprendendo 
          novas <strong>tecnologias</strong> e <strong>metodologias ágeis</strong>. 
          Acredito que a melhor tecnologia é aquela que resolve{" "}
          <strong>problemas reais</strong> de forma simples, eficiente e elegante.
        </p>
      </div>
    </section>
  );
