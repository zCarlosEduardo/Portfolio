  ...
  return (
    ...
    >
      <div className="flex flex-col items-center mb-8">
        ...
        <span className="text-2xl">Um Pouco Sobre Minha Jornada</span>
      </div>
      <div className="max-w-4xl text-gray-800 flex flex-col mt-4 gap-6 px-4 md:px-0 text-center md:text-left">
        <p>
